...
#"ENSCSAG00000002786" RARA
#"ENSCSAG00000016226" IL6ST
#ENSCSAG00000015978 CLU
#ENSCSAG00000016266 YTHDF1
#ENSCSAG00000014105 BCR
#ENSCSAG00000004697 G3BP2
#ENSCSAG00000005276 UPF1
#ENSCSAG00000014606 XPO1
#"ENSCSAG00000012436" SLC8A1
# ENSCSAG00000013481 EPAS1
#ENSCSAG00000014360 CREB5
#ENSCSAG00000012928 ENO3

#ENSCSAG00000012436 SLC8A1
#ENSCSAG00000005411 TRIM8
#ENSCSAG00000007240 COL6A2

#Gene search, genes with high m6a in Vero, losing m6a after infection, showind DEU (the variables genesHighm6aVero were made after filtering the datasets from the "suppFig_plots_covid.R file):
dex_filt %>% filter(imputed_gene_name %in% genesHighm6aVero_nonm6a_uk) %>% arrange(log2fold_WU_Vero)

dex_filt %>% filter(imputed_gene_name %in% intersect(intersect(genesHighm6aVero_nonm6a_wu,genesHighm6aVero_nonm6a_uk),genesHighm6aVero_nonm6a_sa)) %>% arrange(log2fold_WU_Vero)

pdf("~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/compiled_figures/compilation/ENO3_dexSEqplot.pdf")
...
save(dex_filt, file = "~/MondalLab/BEA21P074_Roshan_Vaid/dexseq_counts/dex_filt_deuGenes_dataset_ensemblIDs_geneIDs.rda")
...
pdf("~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/compiled_figures/heatmap_includedExcluded_exons_DEU.pdf")
...
pdf(file="~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/compiled_figures/heatmap_DiffExonUsage.pdf")
...
pdf("~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/compiled_figures/enrichmentGO_DEU_genes_all.pdf")
...
openxlsx::write.xlsx(goTables_deu,file="~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/compiled_figures/tables/enrichmentAnalysisTable_DEUgenes.xls")


# Intersection of DEU genes with m6A peaks in each condition: -------------


all_exonic_m6a_intersections<- fread("/home/akram/MondalLab/BEA21P074_Roshan_Vaid/reference_genomes/bedtools_intersect_Chlorocebus_sabaeus.ChlSab1.1.104.chr_ensembl_flattened_DEXseq_narrowPeaks_vero_wu_uk_sa_EXONIC_PART.tsv",header=F,sep="\t")
...
ggsave("~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/compiled_figures/peaksPerGene_nonDEUGenes.pdf",plot = plotPeaksPerGene_nonDEU,device = "pdf", width = 6,height = 8,dpi = 300)
...
ggsave("~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/compiled_figures/peaksPerGene_random.pdf",plot = plotPeaksPerGene_random,device = "pdf", width = 6,height = 8,dpi = 300)
...
ggsave("~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/compiled_figures/peaksPerGene_DEU_nonInfected_vs_random_AND_peaksPerGeneDEU_conditions.pdf",plot_grid(plotPeaksPerGene_DEU_random,plotPeaksPerGene_DEU),width = 10,height = 8,dpi = 300)
...
openxlsx::write.xlsx(list(top10_deu_commonDEG_intersecting_exon_m6a),"~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/tables/top_deu_commonDEG_intersecting_exon_m6a.xls")
...
pdf("~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/vennDiagram_DEUs_across_strains_threshol10percent.pdf")
...
dev.off()
openxlsx::write.xlsx(list("Common DEUs"=commonDEUs_above_thres,"DEU WU"=deu_genes_wu_abslogFC,"DEU UK"=deu_genes_uk_abslogFC,"DEU SA" =deu_genes_sa_abslogFC),file = "~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/tables/DEU_genes_list_common_across_strains.xls")
...
fwrite(deuGenes_bed,file = "~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/tables/DEUgenes_coordinates.bed", col.names = F,sep = "\t")
...
pdf("~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/compiled_figures/SuppFig4B_DEU_DEXseq_example.pdf",width = 8, height = 6)
...
# qval_cutoff<-1.30103
# vero_peaks<-fread("~/MondalLab/BEA21P074_Roshan_Vaid/peakCalling/peaks_infectedCellsAll_callsummits_pvalue0.01/gathered_single_peak_files/peaks_noecoli/peaks_nodup_uniq_vero_infectedAll_peaks_all_noecoli.narrowPeak",header = F,sep="\t", col.names = cols) %>% filter(`-log10(q.value)`>qval_cutoff)
# 
...
deuSpliceSites_coords<-fread("~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/tables/bedtools_intersect_DEUgenes__splice_sites_coordinates.bed", header = F,sep="\t")
...
pdf("~/MondalLab/BEA21P074_Roshan_Vaid/plots/manuscript_figures/compiled_figures/compilation/suppFig4_m6a_levels_in_DEUgenes_pieChart.pdf", width = 8, height = 8)
